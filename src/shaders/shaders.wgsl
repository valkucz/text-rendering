...
fn fill_sdf(pos: vec2<f32>) -> vec4<f32> {
    ...
    var x = (pos.x - glyph_transform.bbox.x) / (glyph_transform.bbox.z - glyph_transform.bbox.x);
    var y = (pos.y - glyph_transform.bbox.y) / (glyph_transform.bbox.w - glyph_transform.bbox.y);
